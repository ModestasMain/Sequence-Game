...
-- Creates all floating theme + title displays around the lobby island perimeter.
...
for i, cfg in ipairs(DISPLAYS) do
	...
	part.Color      = color
	part.Material   = isTheme and Enum.Material.SmoothPlastic or Enum.Material.Neon
	...
	prompt.ObjectText            = (isTheme and cfg.key .. " Theme" or TitleConfig.Titles[cfg.key].Name .. " Title") .. " — " .. price .. " Coins"
